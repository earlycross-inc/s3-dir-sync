...
var cli = function () { return __awaiter(void 0, void 0, void 0, function () {
    var argv, configFullPath, dirFullPath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                argv = _a.sent();
                configFullPath = path_1.default.join(app_root_path_1.default.path, argv.config);
                dirFullPath = path_1.default.join(app_root_path_1.default.path, argv.dir);
                return [4 /*yield*/, Upload_1.upload(configFullPath, dirFullPath)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
