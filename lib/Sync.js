...
var syncDirectoryWithS3 = function (s3, _a, dirPath) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var localFiles, s3ObjInfos, s3ObjPairs, s3ObjProcStateMap, uploads, _loop_1, _i, localFiles_1, localFile, deletes, deleteBatches, syncOps, errors, flatErrors, headerErrorMsg, flatErrorMsg, syncErrorMsg;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    console.log("sync " + dirPath + " to s3://" + path_1.default.join(bucket, prefix));
                    if (excludePaths !== undefined) {
                        console.log("paths to be excluded:", excludePaths);
                    }
                    console.log('traversing local & S3 files');
                    localFiles = listFilesInLocalDir(dirPath);
                ...
                case 1:
                    ...
                    _loop_1 = function (localFile) {
                        var key = path_1.default.relative(dirPath, localFile).replace(/\\/g, '/');
                    ...
                    syncOps = __spreadArray(__spreadArray([], uploads.map(function (key) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, uploadToS3(s3, bucket, path_1.default.join(dirPath, key), path_1.default.join(prefix, key))];
                    }); }); })), deleteBatches.map(function (keys) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, batchDeleteFromS3(s3, bucket, keys.map(function (key) { return path_1.default.join(prefix, key); }))];
                        });
                    }); }));
...
var listFilesInLocalDir = function (rootPath) {
    ...
    var walk = function (dirPath) {
        for (var _i = 0, _a = fs_extra_1.default.readdirSync(dirPath); _i < _a.length; _i++) {
            var fname = _a[_i];
            var fpath = path_1.default.join(dirPath, fname);
